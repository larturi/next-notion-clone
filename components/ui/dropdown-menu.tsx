...
>(({ className, inset, children, ...props }, refProp) => (
...
>(({ className, sideOffset = 4, ...props }, refProp) => (
...
>(({ className, children, checked, ...props }, refProp) => (
